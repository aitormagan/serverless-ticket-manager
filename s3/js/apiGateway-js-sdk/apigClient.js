...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.donationGet = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(donationGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donationPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['body'], ['body']);
        
        var donationPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/donation').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(donationPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donationOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var donationOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/donation').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(donationOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donationIdGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['id'], ['body']);
        
        var donationIdGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/donation/{id}').expand(apiGateway.core.utils.parseParametersToObject(params, ['id'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(donationIdGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donationIdDelete = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['id'], ['body']);
        
        var donationIdDeleteRequest = {
        ...
        return apiGatewayClient.makeRequest(donationIdDeleteRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donationIdPatch = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['id', 'body'], ['body']);
        
        var donationIdPatchRequest = {
        ...
        return apiGatewayClient.makeRequest(donationIdPatchRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.donationIdOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var donationIdOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/donation/{id}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(donationIdOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.userIdPatch = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['id', 'body'], ['body']);
        
        var userIdPatchRequest = {
            verb: 'patch'.toUpperCase(),
            path: pathComponent + uritemplate('/user/{id}').expand(apiGateway.core.utils.parseParametersToObject(params, ['id', ])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(userIdPatchRequest, authType, additionalParams, config.apiKey);
    };
